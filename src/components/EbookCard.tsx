    ...
    >
      <div className="ebook-card-header">
        ...
        <div className="ebook-card-badges">
          {ebook.hasPages && <span className="badge" data-i18n="card.published">Publicado</span>}
        ...
        <div className="ebook-card-meta">
          ...
          {ebook.lastUpdated && (
            <span 
              ...
              title={`Última actualización: ${ebook.lastUpdated}`}
              data-i18n-title="detail.lastUpdated"
              data-i18n-title-suffix={ebook.lastUpdated}
            >
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="ebook-card-actions">
          {ebook.hasPages && ebook.pagesUrl && (
            ...
            >
              ...
              <span data-i18n="card.viewEbook">Ver Ebook</span>
            </a>
          )}
          <a
          ...
          >
            ...
            <span data-i18n="card.code">Código</span>
          </a>
        </div>
      </div>
    </article>
